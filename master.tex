...
\begin{theorem}
    ...
    vektorju, to je lastnemz vektorju za $\lambda_1$.
\end{theorem}
...
\State $k = 0$
\While{$k = 0, 1, 2, \dots$}
    \State Izračunaj OR razcep matrike A: $A_k = Q_k R_k$
...
\end{gather*}
Na podlagi tega vektorja določimo Householderjevo zrcaljenje, ki uniči elemente od prvega (v tem vektorju) navzdol, torej od drugega navzdol v celotnem stolpcu.
...
Dvojni premik
(prepiši od Eme)
Vzamemo 2x2 matriko v spodnjem desnem kotu, izračunamo lastne vrednosti, 

ČE imamo na prvi poddiagonali v zgornji Hessenbergovi matriki pojavi 0, problem razpade na dva problema.
